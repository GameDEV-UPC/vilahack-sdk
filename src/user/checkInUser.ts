...
import type { CheckInUserErrorCode, CheckInUserResponse, UserRequest } from "./types.js";
...
export async function checkInUser(config: Config, data: UserRequest): Promise<CheckInUserResponse> {
